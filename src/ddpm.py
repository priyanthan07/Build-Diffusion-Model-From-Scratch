...
class DDPMSampler:
    ...
    def step(self, timestep: int, latents: torch.Tensor, model_output: torch.Tensor):
        ...
        pred_prev_sample = pred_original_sample_coeff * pred_original_sample + current_sample_coefficient * latents
    ...
    def add_noise(self, original_samples: torch.FloatTensor, timesteps: torch.IntTensor) -> torch.FloatTensor:
        ...
        sqrt_one_minus_alpha_cumprod = (1-alpha_cumprod[timesteps]) ** 0.5   # standard deviation
